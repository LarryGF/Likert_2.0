...
const app = new Vue({
    ...
    methods: {
            ...
            switch (select) {
                ...
                case "Objective":
                    ...
                    if (this.category == "" || this.name == "") {
                        this.err_msg = "You left required fields empty";
                        return;
                    } else {
                        this.last_id = last_id + 1;
                        dic.id = this.last_id;
        ...
        summary: async function() {
            let result = await eel.summary(
                this.values_list,
                this.likert_table_obj,
                this.users
            )();
            // this.step = '';
